const articleExtrasMap = {
  ...
  "best-areas-to-live-in-dubai": {
    intro: [
      "Neighborhood choice in Dubai isn't just about rent — it shapes your commute stress, social energy, school access, and how much time you actually have each week.",
      "Most people compare areas on price alone. The useful comparison is the full daily living pattern each area creates.",
      "This guide helps both professionals and families cut through the marketing noise and make a decision based on how they actually live.",
    ],
    highlights: [
      "A 30-minute commute saving each way is worth more than an extra bedroom.",
      "Families should verify school, clinic, and grocery access on foot — not on a map app.",
      "Visit your shortlisted areas during rush hour before signing anything.",
    ...
    steps: [
      {
        title: "Step 1: Map Your Daily Destinations First",
        detail:
    ...
    comments: [
      {
        name: "M. Khan",
        text: "The rush hour visit advice changed my whole decision. The area I almost picked had genuinely terrible traffic twice a day.",
        rating: 5,
      },
    ],
  },
  ...
  "uae-labour-law-private-employees": {
    ...
    steps: [
      {
        title: "Step 1: Actually Read What You're Signing",
        detail:
    ...
    comments: [
      {
        name: "Faisal",
        text: "The record-keeping point is genuinely the most important thing here. I learned this the hard way.",
        rating: 5,
      },
    ],
  },
  ...
  "dubai-weekend-itinerary-budget": {
    ...
    steps: [
      {
        title: "Step 1: Build the Route the Night Before",
        detail:
    ...
    comments: [
      {
        name: "Sara J.",
        text: "This is the most realistic budget travel guide I've read for Dubai. It actually accounts for how the city works.",
        rating: 4,
      },
    ],
  },
  ...
  "how-to-find-jobs-in-uae-fast": {
    intro: [
      "Getting hired faster in the UAE is about precision, not volume. The candidates who get responses are the ones who look intentionally right for a specific role — not the ones who sent the most applications.",
      "This guide is for people who want a focused, trackable job search that improves week by week.",
      "You'll leave with a clear process: right targeting, right CV structure, right channels, right follow-up rhythm.",
    ],
    highlights: [
      "Define your target roles narrowly — broad targeting is why most job searches stall.",
      "Rewrite your CV using the language the employer uses in the job description.",
      "Portals are one channel. Direct pages, LinkedIn, and recruiters are three more.",
    ...
    steps: [
      {
        title: "Step 1: Get Specific About the Roles You're Targeting",
        detail:
    ...
    comments: [
      {
        name: "Ankit",
        text: "The tracking advice completely changed how I run my job search. I went from 2 weeks of confusion to knowing exactly what was working.",
        rating: 5,
      },
    ],
  },
  ...
  "emirates-id-renewal-process": {
    intro: [
      "Emirates ID renewal is one of those processes that's simple when you prepare properly and frustrating when you don't.",
      "Most delays come from small, entirely avoidable mistakes — wrong spelling, blurry scan, expired supporting document that slipped notice.",
      "This guide gives you the exact preparation checklist and tracking approach that keeps the process clean from start to finish.",
    ],
    highlights: [
      "Check every document for accuracy before you open the online form — not during.",
      "Name spellings, document numbers, and expiry dates are the most common error sources.",
      "Track your application using the reference number — don't wait passively.",
    ...
    steps: [
      {
        title: "Step 1: Prepare and Verify All Documents Before Starting",
        detail:
    ...
    comments: [
      {
        name: "Nadia",
        text: "The scan quality check saved me. My first attempt failed exactly because of a blurry photo — I didn't realize how strict it was.",
        rating: 5,
      },
    ],
  },
  ...
  "uae-traffic-fine-check-guide": {
    intro: [
      "Traffic fine checks are quick, but the process has a few small steps where people consistently go wrong — and wrong steps mean delayed records or payments in the wrong place.",
      "This guide keeps it simple: official sources, verification before payment, saved receipts, and a routine that prevents last-minute surprises.",
    ],
    highlights: [
      "Always start with official UAE government portals — not third-party sites.",
      "Verify the plate, amount, and violation type before touching the payment button.",
      "Save your receipt the moment payment completes — before closing the page.",
    ...
    comments: [
      {
        name: "Yousef",
        text: "Clear and practical. I've made the monthly check a habit now — took one surprise fine at renewal time to convince me.",
        rating: 5,
      },
    ],
  },
  ...
  "start-small-business-in-dubai": {
    ...
    comments: [
      {
        name: "Khalid A.",
        text: "The demand validation point is exactly what I needed to hear before spending on setup. Clear and direct.",
        rating: 5,
      },
    ],
  },
  ...
  "dubai-metro-and-nol-card-tips": {
    intro: [
      "Dubai's metro is genuinely one of the best daily commuting tools in the city — but only for people who treat it like a system, not a daily improvisation.",
      "Small habits around timing, balance, and route choice create a noticeably better commute over the course of a month.",
      "This guide is for regular commuters who want practical improvements, not transport theory.",
    ],
    highlights: [
      "Leaving 20 minutes earlier often saves more time than it costs — peak hour congestion is real.",
      "Top up your Nol card every Sunday evening — never run dry at a gate during rush hour.",
      "Track weekly transport spend once a month — the total usually surprises people.",
    ...
    comments: [
      {
        name: "MetroUser88",
        text: "The pre-rush top-up habit genuinely changed my mornings. Sounds tiny but it matters when you're in a hurry.",
        rating: 4,
      },
    ],
  },
  ...
  "dubai-digital-marketing-trends-2026": {
    ...
    comments: [
      {
        name: "Local Founder",
        text: "The landing page audit advice is what I needed. Our campaigns improved significantly once we fixed the page alignment before scaling spend.",
        rating: 5,
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────
  // NEW 15 ARTICLES — EXTRAS
  // ─────────────────────────────────────────────
  "dubai-visa-types-expats-2026": {
    intro: [
      "The UAE visa landscape has changed significantly in recent years — there are now more pathways to legal residency than most expats realize.",
      "This guide covers the main categories in plain English: what each one covers, who qualifies, and what the process involves.",
      "If you're unsure which category applies to your situation, start here.",
    ],
    highlights: [
      "Employment visa is most common but not always the best option for your situation.",
      "The Green Visa offers 5-year self-sponsored residency — it's underused because people don't know about it.",
      "Golden Visa is genuinely accessible for property investors above AED 2 million.",
    ...
    budgetRows: [],
    comments: [
      { name: "Priya R.", text: "Finally a clear breakdown. I had no idea the Green Visa existed until I read this.", rating: 5 },
    ],
  },
  ...
  "golden-visa-uae-how-to-apply": {
    ...
    budgetRows: [],
    comments: [
      { name: "Ahmed T.", text: "Finally understood the property value threshold clearly. I was confused about the mortgage aspect before.", rating: 5 },
    ],
  },
  ...
  "freelance-in-dubai-complete-guide": {
    ...
    budgetRows: [],
    comments: [
      { name: "Diana W.", text: "This is the clearest freelance setup guide I've found. The free zone activity category point is genuinely important.", rating: 5 },
    ],
  },
  ...
  "dubai-rental-guide-2026": {
    ...
    budgetRows: [],
    comments: [
      { name: "James F.", text: "The cheque system was a complete surprise. Knowing this before arrival would have changed my savings plan significantly.", rating: 5 },
    ],
  },
  ...
  "health-insurance-uae-guide": {
    ...
    budgetRows: [],
    comments: [
      { name: "Meera P.", text: "The pre-authorization point is critical. I had a claim rejected for exactly this reason — wish I had read this first.", rating: 5 },
    ],
  },
  ...
  "uae-banking-guide-expats": {
    ...
    budgetRows: [],
    comments: [
      { name: "Sana M.", text: "The fee schedule point is so important. I didn't read it and spent months paying avoidable minimum balance charges.", rating: 4 },
    ],
  },
  ...
  "school-guide-dubai-families": {
    ...
    budgetRows: [],
    comments: [
      { name: "Fatima H.", text: "The waitlist timing point is critical. I missed my first choice school by six months because I didn't apply early enough.", rating: 5 },
    ],
  },
  ...
  "uae-driving-license-guide": {
    ...
    budgetRows: [],
    comments: [
      { name: "Rahul S.", text: "Training consistently is the key insight. I went from twice a week to four times a week and finished in half the expected time.", rating: 5 },
    ],
  },
  ...
  "uae-gratuity-end-of-service-calculator": {
    ...
    budgetRows: [],
    comments: [
      { name: "Tariq B.", text: "The basic salary versus total package distinction is so important and so often missed. This saved me from accepting an underpayment.", rating: 5 },
    ],
  },
  ...
  "uae-work-permit-guide": {
    ...
    budgetRows: [],
    comments: [
      { name: "Lily C.", text: "The free zone versus mainland distinction matters more than people realize. I was escalating to the wrong authority for months.", rating: 4 },
    ],
  },

  "abu-dhabi-vs-dubai-living-guide": {
    intro: [
      "Abu Dhabi and Dubai are both excellent cities to live in — but they suit very different kinds of people and career profiles.",
      "Choosing based on familiarity (most people default to Dubai) rather than fit means some people spend years in the wrong city.",
      "This honest comparison covers cost, careers, lifestyle pace, and daily quality of life.",
    ],
    highlights: [
      "Abu Dhabi suits government, oil and gas, and defense sector professionals better.",
      "Dubai is the clear choice for private sector, trade, logistics, and hospitality careers.",
    ...
    budgetRows: [],
    comments: [
      { name: "Omar H.", text: "The industry-first advice is exactly right. I moved to Abu Dhabi because Dubai seemed more exciting and regretted it — my entire professional network was in the wrong city.", rating: 5 },
    ],
  },
  ...
  "dubai-food-guide-locals-expats": {
    ...
    budgetRows: [],
    comments: [
      { name: "Laura K.", text: "Al Karama completely changed my food budget. I was spending triple what I needed to by eating near my office.", rating: 5 },
    ],
  },
  ...
  "remittance-sending-money-abroad-uae": {
    ...
    budgetRows: [],
    comments: [
      { name: "Raj P.", text: "I switched from my bank to Wise for regular transfers and the difference over 12 months was nearly AED 900 in my family's account. Real money.", rating: 5 },
    ],
  },
  ...
  "uae-tax-free-income-guide": {
    ...
    budgetRows: [],
    comments: [
      { name: "Claire D.", text: "The home country obligation section is exactly what most UAE guides skip. Essential reading for US and UK expats especially.", rating: 5 },
    ],
  },
...
const defaultExtras = {
  intro: [
    "This article gives you practical guidance with clear steps and realistic expectations — not generic advice you've seen a hundred times.",
    "Use the steps, checkpoints, and key takeaways below to make the topic immediately applicable to your situation.",
  ],
  highlights: [
    "Start with verified, current information from official or trusted sources.",
    "Keep your documents and records organized from day one.",
    "Build regular review habits — weekly or monthly depending on the topic.",
  ...
  comments: [
    {
      name: "Dubai Resident",
      text: "Clear, practical, and actually useful. The steps are sensible and easy to follow.",
      rating: 5,
    },
  ],
};
